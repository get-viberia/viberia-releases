...
> Think SimCity, but for AI teams.

Plan, staff, and scale your AI city. Dev, Design, Ops — all on one map.
Local-first. BYO keys and subscriptions.

## Download

| Platform | Download |
|----------|----------|
| macOS (Apple Silicon / Intel) | [Latest Release](../../releases/latest) |
