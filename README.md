...
1. Download the build for your Mac:
   - **Apple Silicon (M1 or later):** [Viberia_0.6.4_aarch64.dmg](https://github.com/get-viberia/viberia-releases/releases/download/v0.6.4/Viberia_0.6.4_aarch64.dmg)
   - **Intel:** [Viberia_0.6.4_x64.dmg](https://github.com/get-viberia/viberia-releases/releases/download/v0.6.4/Viberia_0.6.4_x64.dmg)
...
1. Download the installer for your architecture:
   - **x64 (most PCs):** [Viberia_0.6.4_x64-setup.exe](https://github.com/get-viberia/viberia-releases/releases/download/v0.6.4/Viberia_0.6.4_x64-setup.exe)
   - **ARM64 (e.g. Snapdragon X / Surface Pro 11):** [Viberia_0.6.4_arm64-setup.exe](https://github.com/get-viberia/viberia-releases/releases/download/v0.6.4/Viberia_0.6.4_arm64-setup.exe)
...
- [Release Notes](https://github.com/get-viberia/viberia-releases/releases/tag/v0.6.4)
